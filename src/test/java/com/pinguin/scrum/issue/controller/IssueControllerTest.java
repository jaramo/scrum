...
//    @Test
//    public void testAssignBugToDeveloperReturns204() throws Exception {
//        MvcResult result = mvc.perform(
//                post("/issues/bugs")
//                    .contentType(MediaType.APPLICATION_JSON)
//                    .content(TestUtils.toJson(bugRequest)))
//                .andExpect(status().isCreated())
//                .andReturn();
//
//        BugResponse response = TestUtils.getResponse(result, BugResponse.class);
//
//        mvc.perform(
//                put(String.format("/issues/bugs/%d/assign/%d", response.id, testDeveloper.getId()))
//                    .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNoContent());
//    }

//    @Test
//    public void testAssignBugToDeveloperReturns404ForDeveloperNotFound() throws Exception {
//        MvcResult result = mvc.perform(
//                post("/issues/bugs")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(TestUtils.toJson(bugRequest)))
...
//
//        mvc.perform(
//                put(String.format("/issues/bugs/%d/assign/9999999999999", response.id))
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNotFound())
//                .andExpect(status().reason("Developer not found"));
//    }
//
//    @Test
//    public void testAssignBugToDeveloperReturns404ForIssueNotFound() throws Exception {
//        MvcResult result = mvc.perform(
//                post("/issues/bugs")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(TestUtils.toJson(bugRequest)))
...
//
//        mvc.perform(
//                put(String.format("/issues/bugs/99999999/assign/%d", testDeveloper.getId()))
//                        .contentType(MediaType.APPLICATION_JSON))
//                .andExpect(status().isNotFound())
//                .andExpect(status().reason("Issue not found"));
//    }
}
